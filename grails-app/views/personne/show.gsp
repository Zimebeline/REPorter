...
<%@ page import="myproject.Personne" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-personne" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:personneInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${personneInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
